...
const envSchema = z
  .object({
    ...
    // contacts access.
    DAV_USERNAME: optionalSetting(z.string()),
    DAV_PASSWORD: optionalSetting(z.string()),
